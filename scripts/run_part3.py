...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the Part 3 advanced video object removal pipeline.")
    ...
    parser.add_argument(
        ...
        default=[],
        metavar="KEY=VALUE",
        help="Override config values. Example: --set output.dataset_name=tennis",
    )
    return parser
